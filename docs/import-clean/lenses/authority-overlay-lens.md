...
Maps declared authority hierarchies onto observed structure to detect
absence, override, or conflict.
...
Failure exists when structural regions lack declared authority or
contain overlapping unresolved authority.
