...
summary: >-
  A structural condition where an effect, declaration, authority, constraint, or
  state increases in scope or intensity as it propagates beyond declared bounds.
code: PAT-0360
---
